...
public class SECP256K1 {
  ...
  public static boolean verify(
      final Bytes data, final Signature signature, final PublicKey pub, final UnaryOperator<Bytes> preprocessor) {
  ...
  public static class PublicKey implements java.security.PublicKey {
    ...
    public static Optional<PublicKey> recoverFromSignature(final Bytes32 dataHash, final Signature signature) {
